...
class ReleaseTest {
    ...
    @Test
    void testEquals() {
        assertEquals(madonnaAngelUKMaxiSingle.toString(), "Id de album: 01, de Madonna su titulo es: Angel (UK 12\" Single)y estas son sus canciones:[Angel (Extended Dance Mix), de Madonna dura 6:15 y ocupa la posición A1, Burning Up, de Madonna dura 4:48 y ocupa la posición B1]");
    ...
    @Test
    void ObtenerDatos(){
        assertEquals(madonnaAngelUSMaxiSingle.getRelease(), "8b53c32c-ee79-42b1-a7a9-bd7c63322c31");
        assertEquals(madonnaAngelUSMaxiSingle.getTracklist().toString(), "[Into The Groove, de Madonna dura 4:40 y ocupa la posición B1, Angel (Extended Dance Mix), de Madonna dura 6:15 y ocupa la posición A1]");
        assertEquals(madonnaAngelUSMaxiSingle.getTitle(), "Angel (US 12\" Single)");
        assertEquals(madonnaAngelUSMaxiSingle.getArtist(),"Madonna");
        madonnaAngelUSMaxiSingle.setID(3);
        assertEquals(madonnaAngelUSMaxiSingle.getID(),3);
    }


    @Test
    void tostring() {
        assertEquals(madonnaAngelUSMaxiSingle.toString(), "Id de album: 01, de Madonna su titulo es: Angel (US 12\" Single)y estas son sus canciones:[Into The Groove, de Madonna dura 4:40 y ocupa la posición B1, Angel (Extended Dance Mix), de Madonna dura 6:15 y ocupa la posición A1]");
